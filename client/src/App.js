...
export default function App() {
  ...
  function locate() {
    if (!navigator.geolocation) return setError('This browser does not support location. Search for a city instead.');
  ...
  return <div className="app-shell">
    ...
    <main id="main"><div className="page-heading"><div><div className="eyebrow">A BETTER WAY TO GET THERE</div><h1>Your journey. A little greener.</h1><p>Discover your route, understand its impact, and travel thoughtfully.</p></div><span className="pill">↗ Built for better journeys</span></div>
    ...
    </>}<footer><span>EcoRoute AI <span className="muted">/ Every journey is a choice.</span></span><span>Maps © OpenStreetMap · Routes by OSRM · Weather by Open-Meteo</span></footer></main></div></div>;
}
